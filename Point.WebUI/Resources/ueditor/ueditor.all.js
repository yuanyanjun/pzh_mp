...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , UEDITOR_CORPID: window.UEDITOR_CORPID
        , UEDITOR_USERID: window.UEDITOR_USERID

        //图片上传配置区
        , imageUrl: URL + "net/imageUp.ashx"             //图片上传提交地址
        , imagePath: UEDITOR_IMG1URL //URL + "net/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        , imageManagerPath: UEDITOR_IMG1URL //URL + "net/"                                    //图片修正地址，同imagePath
        ...
        , toolbars: [
            ['fullscreen', 'showface', 'insertimage', 'bold', 'italic', 'underline', 'strikethrough'
                , 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify'
                , 'insertorderedlist', 'insertunorderedlist', 'forecolor', 'backcolor'
                , 'paragraph', 'fontfamily', 'fontsize', 'source'
            ]
        ]
        //, toolbars: [
    ...
    removeAttributes:function (node, attrNames) {
        ...
        for (var i = 0, ci; ci = attrNames[i++];) {
            ...
            switch (ci) {
                ...
                case 'style':
                    node.style.cssText = '';
                    if (node.getAttributeNode('style') !== null) {  // 处理表格粘贴的BUG
...
(function () {
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch', 'showface',
